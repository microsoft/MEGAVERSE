...
VERBALIZERS = {
    "xnli": {"Entailment": "True", "Contradiction": "False", "Neutral": "Neither"},
    "paws-x": {"True": "True", "False": "False"},
    "xcopa": {"{choice1}": "choice1", "{choice2}": "choice2"},
    "xstorycloze": {"{sentence_quiz1}": "Option1", "{sentence_quiz2}": "Option2"},
    "panx": {
