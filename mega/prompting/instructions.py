INSTRUCTIONS = {
    ...
    "belebele": "You are an AI assistant whose purpose is to perform reading comprehension task. You will be provided a question on a passage and four possible answers to the question. You need to choose the most appropriate answer to the question with respect to passage. Help me pickup from the given answer option 1, option 2, option 3 and option 4"
}   
