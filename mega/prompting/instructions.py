INSTRUCTIONS = {
    ...
    "afriqa": "You are an NLP assistant trained to answer questions directly. For each question provided, respond with the most accurate and concise answer. The answer should be in the same language as the question.",
