...
do
    ...
    do
        ...
        do
            ...
            python -m mega.eval_xnli -p $lang -t $lang --pivot_prompt_name "${prompt_name}" --tgt_prompt_name "${prompt_name}" -k $k --model "gemini-pro" -e gpt4v3 --chat_prompt --temperature 0 --timeout 30
        done
    done
done